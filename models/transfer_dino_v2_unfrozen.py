...
CHECKPOINT_DIR = "checkpoints/transfer_dino_v2_unfrozen"
...
def create_transfer_dino_v2_unfrozen(num_classes=2):
    """
    Creates a transfer learning model using DINOv2 with weights unfrozen for mask detection.
    ...
    x = backbone_model(x, training=True)
