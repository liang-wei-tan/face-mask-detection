...
CHECKPOINT_DIR = "checkpoints/transfer_inception_unfrozen"
...
def create_transfer_inception_unfrozen(num_classes=2):
    """
    ...
    base_model.trainable = True ## change here
    num_classes = 2
    ...
    x = base_model(x, training=True) ## change here
